...
interest over a given time period. If you are at all unfamiliar with the
theory of Survival Analysis, please take a look at Jason's project
(<http://staging.inertia7.com/projects/jason>).
...
This part needs work still. I need to find a way to implement a method
to extract the baseline hazard rate.
